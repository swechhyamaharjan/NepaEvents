...
export const PaymentSuccess = () => {
  ...
  useEffect(() => {
    // If you have a session ID, fetch the booking details
    if (sessionId) {
            ...
            <div className="bg-white rounded-xl p-6 mb-6 shadow-md border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="text-gray-800 font-semibold">{bookingDetails.venueName}</span>
                </div>
                
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="text-gray-600 font-medium">Event Title:</span>
                  <span className="text-gray-800 font-semibold">{bookingDetails.eventTitle}</span>
                </div>
                
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="text-gray-600 font-medium">Event Category:</span>
                  <span className="text-gray-800 font-semibold">{bookingDetails.eventCategory}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="text-gray-800 font-semibold">{bookingDetails.capacity} people</span>
                </div>
                
                <div className="mt-2 pt-4 flex justify-between items-center bg-gray-50 p-4 rounded-lg">
                  <span className="text-gray-800 font-bold">Total Amount:</span>
                  <div className="flex flex-col items-end">
                    <span className="text-2xl font-bold text-[#ED4A43]">Rs. {bookingDetails.totalAmount.toFixed(2)}</span>
