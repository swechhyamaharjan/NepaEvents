      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-10">
          <div className="relative">
            <img
              src={venue?.image ? `http://localhost:3000/${venue.image.replace(/\\/g, '/')}` : '/images/event1.png'}
              alt={venue?.name}
          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              <button
                ...
                className={`py-4 px-6 text-center border-b-2 font-medium text-sm md:text-base ${activeTab === "description"
              ...
              <button
                ...
                className={`py-4 px-6 text-center border-b-2 font-medium text-sm md:text-base ${activeTab === "details"
                    ? "border-[#ED4A43] text-[#ED4A43]"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
              >
              ...
              <button
                ...
                className={`py-4 px-6 text-center border-b-2 font-medium text-sm md:text-base ${activeTab === "terms"
                    ? "border-[#ED4A43] text-[#ED4A43]"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
              >
