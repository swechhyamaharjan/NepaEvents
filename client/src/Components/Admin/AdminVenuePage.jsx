                ...
                getFilteredVenues().map((venue) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <img
                        src={venue?.venue?.image ? `http://localhost:3000/${venue.venue.image.replace(/\\/g, '/')}` : '/images/event1.png'}
                        alt={venue.name}
                        className="w-full h-56 object-cover transform group-hover:scale-105 transition-transform duration-700"
                        onError={(e) => { e.target.onerror = null; e.target.src = '/images/event1.png'; }}
                      />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative w-full h-56 rounded-lg overflow-hidden border border-gray-200">
                    <img
                      src={detailVenue?.image ? `http://localhost:3000/${detailVenue.image.replace(/\\/g, '/')}` : '/images/event1.png'}
